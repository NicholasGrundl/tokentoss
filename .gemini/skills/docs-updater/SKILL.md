---
name: docs-updater
description: Expert documentation specialist for updating README.md and AI context files (GEMINI.md/CLAUDE.md). Use when the user asks to "update docs", "refresh documentation", or "update the readme".
---
